...
const ParticipantList = ({ isOpen, onClose, localUser, localAudio, localVideo, remoteUsers = [], meetingHostId }) => {
  ...
  return (
    <aside className='w-full sm:w-80 h-full bg-white border-slate-200 flex flex-col z-30 shadow-2xl animate-in slide-in-from-right duration-200'>
      {/* HEADER */}
          ...
          return (
            ...
            <div key={p.socketId}
              ...
              <div className='flex items-center gap-3'>
                <div className='w-9 h-9 rounded-full bg-primary-light border border-primary-border text-primary font-bold flex items-center justify-center text-sm shadow-sm'>
